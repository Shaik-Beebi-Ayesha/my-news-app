...
import {addFavItem , removeFavItem } from './redux/authSlice';
      ...
      const fetchNews = async () => {
        ...
        try {
          const response = await fetch(
            "https://newsapi.org/v2/everything?q=US&apiKey=eb417353bc29429e8bf40701df2b481a"
          );
          if (!response.ok) {
    ...
    <div >
      {
            allArticles?.length==0 && (
              <div className="flex justify-center items-center mt-40 mx-3">
                <div className="">
                <p className="text-2xl text-center font-bold text-gray-500">Oops! Looks like the articles are taking a nap.</p>
                <p className="text-gray-500 text-center">Try refreshing the page or check if your internet is playing hide-and-seek.</p>
                </div>
              </div>
            )
          }
